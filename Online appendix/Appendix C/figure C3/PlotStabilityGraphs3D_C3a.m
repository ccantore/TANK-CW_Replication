...
%Parameter3Steps = 15;
Parameter3 = 'phi_pi';
Parameter3String = horzcat('\phi^{\pi}'); 
Parameter3Min = 0.01;
Parameter3Max = 2;
Parameter3Steps = 15;
...
zlabel(horzcat('$\phi^{\pi}$'),'fontsize',FontsizeAxis,'interpreter','latex'); 
...
ylabel(horzcat('Hand to Mouth share ','($\lambda$)'),'fontsize',FontsizeAxis,'interpreter','latex'); 

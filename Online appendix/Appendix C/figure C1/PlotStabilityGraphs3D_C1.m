...
Parameter1 = 'phi'; 
Parameter1String = 'Inverse Frisch elasticity ($\varphi$)';
...
Parameter2 = 'lambda';
Parameter2String = 'Hand-to-mouth share ($\lambda$)';
...
%Parameter3Steps = 15;
Parameter3 = 'phi_pi';
Parameter3String = horzcat('\phi_{\pi}'); 
Parameter3Min = 0.01;
Parameter3Max = 2;
Parameter3Steps = 15;
...
%ylabel(horzcat('$',Parameter2String,'$'),'fontsize',FontsizeAxis,'interpreter','latex');   
ylabel(horzcat('HtM share ','($\lambda$)'),'fontsize',FontsizeAxis,'interpreter','latex'); 
%zlabel(horzcat('$',Parameter3String,'$'),'fontsize',FontsizeAxis,'interpreter','latex');  
zlabel(horzcat('Taylor rule coefficient on inflation ','($\phi^{\pi}$)'),'fontsize',FontsizeAxis,'interpreter','latex'); 

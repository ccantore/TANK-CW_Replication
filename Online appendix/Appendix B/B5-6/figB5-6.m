...
% Output options
OptionPrint = 1;        
FigName = 'fig_sensi_UW_psiw_linear';
TargetPath = './Output/';


% Names of files to be loaded (.mat) whether they're linear or non-linear, and
% how they're called in figures
RESULT_names={'tank_uw_results_psiW007','tank_uw_results_psiW025','tank_uw_results_psiW05'};%,'TANKs_results'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD
%RESULT_names={'tank_cw_results_psiW007','tank_cw_results_psiW025','tank_cw_results_psiW05'};%,'TANKs_results'}; %%EXACT NAMES OF THE RESULTS FILES TO LOAD

lin_vs_nonlin=[1,1,1]; % = 0 if corresponding model non-linear, 1 otherwise
Model_names=char('\psi^W=0.075','\psi^W=0.25','\psi^W=0.5'); %NAMES OF THE MODEL VARIANTS TO APPEAR IN THE LEGEND OF THE GRAPHS
